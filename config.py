...
For support, contact your family admin.""",
        ...
        'no_bought_items_found': "📋 **No Bought Items Found**\n\n🛒 **{supermarket_list}** - No bought items to reset.\n\n✅ All items are still pending.",
...
לתמיכה, פנה למנהל המשפחה שלך.""",
        ...
        'no_bought_items_found_hebrew': "📋 **לא נמצאו פריטים נקנים**\n\n🛒 **{supermarket_list}** - אין פריטים נקנים לאיפוס.\n\n✅ כל הפריטים עדיין ממתינים.",
