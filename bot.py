...
class ShoppingBot:
    ...
    def get_message(self, user_id: int, key: str, **kwargs) -> str:
        ...
        # First try to get the message with the exact key
        message = MESSAGES.get(lang, MESSAGES['en']).get(key, MESSAGES['en'].get(key, key))
        
        # If message is the same as key (not found) and user is Hebrew, try with _hebrew suffix
        if message == key and lang == 'he':
            hebrew_key = f"{key}_hebrew"
            message = MESSAGES.get(lang, MESSAGES['en']).get(hebrew_key, MESSAGES['en'].get(hebrew_key, key))
    ...
    def translate_template_name(self, template_name: str) -> str:
        ...
        translations = {
            ...
            'Healthy Week': 'שבוע בריא',
            'Spring Cleaning': 'ניקיון אביב',
            'Party Shopping': 'קניות מסיבה',
            'Quick Essentials': 'חיוניות מהירות',
            'Moving Days': 'ימי מעבר',
            'Weekend Trip': 'טיול סוף שבוע',
            'Business Trip': 'נסיעת עסקים',
            'Quick Meals': 'ארוחות מהירות',
            'Family Dinner': 'ארוחת ערב משפחתית',
            'Weekend Shopping': 'קניות סוף שבוע',
            'Holiday Prep': 'הכנה לחג',
            'Summer Essentials': 'חיוניות קיץ',
            'Winter Essentials': 'חיוניות חורף',
            'Back to School': 'חזרה לבית הספר',
            'Party Supplies': 'אספקת מסיבה',
            'Emergency Kit': 'ערכת חירום',
            'Pet Care': 'טיפול בחיות מחמד',
            'Office Supplies': 'אספקת משרד',
            'Cleaning Supplies': 'אספקת ניקיון',
            'Personal Care': 'טיפול אישי',
            'Sports & Fitness': 'ספורט וכושר',
            'Travel Essentials': 'חיוניות נסיעה',
            'Garden & Outdoor': 'גינה וחוץ',
            'Tech & Electronics': 'טכנולוגיה ואלקטרוניקה'
        }
    ...
    def translate_template_items(self, items: list) -> list:
        ...
        translations = {
            ...
            'Green tea': 'תה ירוק',
            'Spinach': 'תרד',
            'Oatmeal': 'דייסת שיבולת שועל',
            'Suit': 'חליפה',
            'Dress shirt': 'חולצה רשמית',
            'Tie': 'עניבה',
            'Pen': 'עט',
            'Pencil': 'עיפרון',
            'Notebook': 'מחברת',
    ...
    def translate_item_name(self, item_name: str, user_id: int) -> str:
        ...
        # Comprehensive Hebrew translation dictionary for all items in database
        translations = {
            # Basic Food Items
            'Milk': 'חלב',
            'Bread': 'לחם',
            ...
            'Sponge': 'ספוג',
            'Trash Bag': 'שקית זבל',
            'Paper Towel': 'מגבת נייר',
            'Aluminum Foil': 'נייר אלומיניום',
            'Plastic Wrap': 'ניילון נצמד',
            'Ziploc Bag': 'שקית עם רוכסן',
            'Band Aid': 'פלסטר',
            'Pain Reliever': 'משכך כאבים',
            'Vitamins': 'ויטמינים',
            'Medical Tape': 'סרט רפואי',
            'Garden Tools': 'כלי גינה',
            'Plant Markers': 'סימני צמחים',
            ...
            'Dog Food': 'מזון לכלבים',
            'Cat Food': 'מזון לחתולים',
            'Fish Food': 'מזון לדגים',
            'Bird Food': 'מזון לציפורים',
            'Hamster Food': 'מזון לאוגרים',
            'Rabbit Food': 'מזון לארנבים',
            'Dog Treats': 'חטיפים לכלבים',
            'Cat Treats': 'חטיפים לחתולים',
            'Pet Toys': 'צעצועים לחיות מחמד',
            'Pet Bed': 'מיטה לחיות מחמד',
            'Pet Collar': 'קולר לחיות מחמד',
            'Pet Leash': 'רצועה לחיות מחמד',
            'Pet Bowl': 'קערה לחיות מחמד',
            'Pet Litter': 'חול לחתולים',
            'Pet Shampoo': 'שמפו לחיות מחמד',
            'Laptop Charger': 'מטען למחשב נייד',
            'Power Adapter': 'מתאם חשמל',
            'Travel Adapter': 'מתאם נסיעות',
            'Universal Adapter': 'מתאם אוניברסלי',
            'Phone Charger': 'מטען לטלפון',
            'USB Cable': 'כבל USB',
            'Headphones': 'אוזניות',
            'Speaker': 'רמקול',
            'Microphone': 'מיקרופון',
            ...
            'Flash Drive': 'דיסק און קי',
            'External Hard Drive': 'דיסק קשיח חיצוני',
            'Mouse': 'עכבר',
            'Keyboard': 'מקלדת',
            'Monitor': 'מסך',
            'Printer': 'מדפסת',
            ...
            'Router': 'נתב',
            'Modem': 'מודם',
            'Ethernet Cable': 'כבל אתרנט',
            'WiFi Extender': 'מרחיב WiFi',
            'Surge Protector': 'מגן נגד נחשולי חשמל',
            'Extension Cord': 'כבל הארכה',
            'Battery': 'סוללה',
            'Rechargeable Battery': 'סוללה נטענת',
            ...
            'Matches': 'גפרורים',
            'Lighter': 'מצית',
            'Fire Extinguisher': 'מטף כיבוי',
            'Smoke Detector': 'גלאי עשן',
            'Carbon Monoxide Detector': 'גלאי פחמן חד חמצני',
            'First Aid Kit': 'ערכת עזרה ראשונה',
            'Emergency Kit': 'ערכת חירום',
            'Toolbox': 'קופסת כלים',
            'Hammer': 'פטיש',
            ...
            'Utility Knife': 'סכין שירות',
            'Safety Glasses': 'משקפי בטיחות',
            'Work Gloves': 'כפפות עבודה',
            'Hard Hat': 'קסדת בטיחות',
            'Safety Vest': 'אפוד בטיחות',
            'Reflective Tape': 'סרט מחזיר אור',
            'Warning Sign': 'שלט אזהרה',
            'Caution Tape': 'סרט זהירות',
            'Barrier': 'מחסום',
            'Cone': 'קונוס',
            'Traffic Cone': 'קונוס תנועה',
            'Road Block': 'חסימת כביש',
            'Detour Sign': 'שלט עקיפה',
            'Stop Sign': 'שלט עצור',
            'Yield Sign': 'שלט תן זכות',
            'Speed Limit Sign': 'שלט הגבלת מהירות',
            'No Parking Sign': 'שלט איסור חניה',
            'One Way Sign': 'שלט כיוון אחד',
            'Dead End Sign': 'שלט ללא מוצא',
            'School Zone Sign': 'שלט אזור בית ספר',
            'Construction Sign': 'שלט בניה',
            'Road Work Sign': 'שלט עבודות כביש',
            'Road Closed Sign': 'שלט כביש סגור',
            'Bridge Out Sign': 'שלט גשר סגור',
            'Road Narrows Sign': 'שלט כביש צר',
            'Slippery When Wet Sign': 'שלט חלק כשרטוב',
            'Deer Crossing Sign': 'שלט חציית צבאים',
            'Pedestrian Crossing Sign': 'שלט חציית הולכי רגל',
            'Bicycle Crossing Sign': 'שלט חציית אופניים',
            'Railroad Crossing Sign': 'שלט חציית מסילת רכבת',
            'Truck Crossing Sign': 'שלט חציית משאיות',
            'Animal Crossing Sign': 'שלט חציית בעלי חיים',
            'Wildlife Crossing Sign': 'שלט חציית חיות בר',
            'Farm Equipment Sign': 'שלט ציוד חקלאי',
            'Slow Moving Vehicle Sign': 'שלט רכב איטי',
            'Oversize Load Sign': 'שלט מטען גדול',
            'Wide Load Sign': 'שלט מטען רחב',
            'Long Load Sign': 'שלט מטען ארוך',
            'High Load Sign': 'שלט מטען גבוה',
            'Low Clearance Sign': 'שלט גובה נמוך',
            'Height Limit Sign': 'שלט הגבלת גובה',
            'Weight Limit Sign': 'שלט הגבלת משקל',
            'Axle Weight Limit Sign': 'שלט הגבלת משקל ציר',
            'Gross Weight Limit Sign': 'שלט הגבלת משקל כולל',
            'Tandem Axle Weight Limit Sign': 'שלט הגבלת משקל ציר טנדם',
            'Single Axle Weight Limit Sign': 'שלט הגבלת משקל ציר יחיד',
            'Truck Weight Limit Sign': 'שלט הגבלת משקל משאית',
            'Bus Weight Limit Sign': 'שלט הגבלת משקל אוטובוס',
            'Trailer Weight Limit Sign': 'שלט הגבלת משקל נגרר',
            'Combination Weight Limit Sign': 'שלט הגבלת משקל שילוב',
            'Gross Combination Weight Limit Sign': 'שלט הגבלת משקל שילוב כולל',
            'Truck Tractor Weight Limit Sign': 'שלט הגבלת משקל טרקטור משאית',
            'Semi Trailer Weight Limit Sign': 'שלט הגבלת משקל נגרר חצי',
            'Double Trailer Weight Limit Sign': 'שלט הגבלת משקל נגרר כפול',
            'Triple Trailer Weight Limit Sign': 'שלט הגבלת משקל נגרר משולש',
            'Quad Trailer Weight Limit Sign': 'שלט הגבלת משקל נגרר מרובע',
            'Quint Trailer Weight Limit Sign': 'שלט הגבלת משקל נגרר מחומש',
            'Sextuple Trailer Weight Limit Sign': 'שלט הגבלת משקל נגרר משושה',
            'Septuple Trailer Weight Limit Sign': 'שלט הגבלת משקל נגרר משובע',
            'Octuple Trailer Weight Limit Sign': 'שלט הגבלת משקל נגרר משובע',
            'Nonuple Trailer Weight Limit Sign': 'שלט הגבלת משקל נגרר משובע',
            'Decuple Trailer Weight Limit Sign': 'שלט הגבלת משקל נגרר משובע',
            'Ice cream': 'גלידה',
            'Cookies': 'עוגיות',
            'Crackers': 'קרקרים',
            'Nuts': 'אגוזים',
            ...
            'Soft drinks': 'משקאות קלים',
            'Vanilla': 'וניל',
            'Red apples': 'תפוחים אדומים',
            'Ripe': 'בשל',
            'Spaghetti': 'ספגטי',
            'Basmati': 'בסמטי',
            'Household': 'מוצרי בית',
            'Paper napkins': 'מפיות נייר',
            'Disposable': 'חד פעמי',
            'Breast': 'חזה',
            'Office': 'משרד',
            'Networking': 'רשתות',
            'Meeting notes': 'הערות פגישה',
            'Professional': 'מקצועי',
            'Chocolate chip': 'צ\'יפס שוקולד',
            'Cheese crackers': 'קרקרים גבינה',
            'Sour cream': 'שמנת חמוצה',
            'Mixed nuts': 'אגוזים מעורבים',
            'Russet': 'רוסט',
            'Fresh': 'טרי',
            ...
            'Family size': 'גודל משפחה',
            'Individual': 'יחיד',
            'Pack of 6': 'חבילה של 6',
            'Pack of 12': 'חבילה של 12',
            'Bulk': 'בכמות גדולה',
            'Premium': 'פרימיום',
            'Budget': 'תקציב',
            'Sale': 'מבצע',
            'Clearance': 'פינוי מלאי'
        }
    ...
    async def handle_callback(self, update: Update, context: ContextTypes.DEFAULT_TYPE):
        ...
        # Category creation callbacks
        ...
        elif data == "template_management_menu":
            # Show template management menu
            await query.answer("📋 Loading template management...")
            await self.show_template_management_menu(update, context)
        
        elif data.startswith("template_management_"):
            # Handle template management for specific list
            list_id = int(data.replace("template_management_", ""))
            await query.answer("📋 Loading templates...")
            ...
            await query.answer("📊 Loading template statistics...")
        ...
        # Template callback handlers
        ...
        elif data.startswith("delete_user_template_"):
            template_id = int(data.replace("delete_user_template_", ""))
            await self.delete_user_template(update, context, template_id)
        
        elif data.startswith("confirm_delete_user_template_"):
            template_id = int(data.replace("confirm_delete_user_template_", ""))
            await self.confirm_delete_user_template(update, context, template_id)
        
        elif data.startswith("manage_my_templates_"):
            list_id = int(data.replace("manage_my_templates_", ""))
            await self.show_manage_my_templates(update, context, list_id)
        
        elif data.startswith("edit_user_template_"):
            template_id = int(data.replace("edit_user_template_", ""))
            ...
            # Extract category_key and template_id from callback data
            # Format: template_category_<category_key>_<template_id>
            callback_data = data.replace("template_category_", "")
            # Find the last underscore to separate category_key from template_id
    ...
    async def show_voice_search_prompt(self, update: Update, context: ContextTypes.DEFAULT_TYPE):
        ...
        try:
            ...
            if availability_status['available']:
                if user_lang == 'he':
                    prompt_text += f"\n\n✅ {self.get_message(user_id, 'voice_recognition_available_hebrew')}"
                    if availability_status['methods']:
                        prompt_text += f"\n🔧 {self.get_message(user_id, 'voice_methods_hebrew')}: {', '.join(availability_status['methods'])}"
                else:
                    prompt_text += f"\n\n✅ {self.get_message(user_id, 'voice_recognition_available')}"
                    if availability_status['methods']:
                        prompt_text += f"\n🔧 {self.get_message(user_id, 'voice_methods')}: {', '.join(availability_status['methods'])}"
            else:
                if user_lang == 'he':
                ...
                if user_lang == 'he':
                    ...
                    prompt_text += "\n💡 " + self.get_message(user_id, 'voice_messages_manual_typing')
    ...
    async def show_finalize_confirmation(self, update: Update, context: ContextTypes.DEFAULT_TYPE, list_id: int):
        ...
        keyboard = [
            ...
            [InlineKeyboardButton(self.get_message(user_id, 'btn_no'), callback_data="noop")],
                    ...
                    for category in category_keys:
                        ...
                        for item in category_items:
                            ...
                            if item_status['status'] == 'bought':
                                bought_button = f"✓{bought_text}"  # Already bought - add checkmark
                                not_found_button = not_found_text   # Regular not found button
                            elif item_status['status'] == 'not_found':
                                bought_button = bought_text    # Regular bought button  
                                not_found_button = f"✓{not_found_text}"  # Already not found - add checkmark
                            else:
                                bought_button = bought_text    # Regular bought button
                                not_found_button = not_found_text   # Regular not found button
    ...
    async def show_remove_items_menu(self, update: Update, context: ContextTypes.DEFAULT_TYPE, list_id: int):
        ...
        for category, category_items in grouped_items.items():
            category_name = self.get_category_name(user_id, category)
            items_count_text = self.get_message(user_id, 'items_count_inline').format(count=len(category_items))
            keyboard.append([InlineKeyboardButton(
                f"📂 {category_name} ({items_count_text})", 
        ...
        keyboard.append([InlineKeyboardButton(
            self.get_message(user_id, 'btn_remove_individual_items'), 
    ...
    async def show_individual_items_removal(self, update: Update, context: ContextTypes.DEFAULT_TYPE, list_id: int):
        ...
        user_lang = self.get_user_language(user_id)
        if user_lang == 'he':
            message = f"🔍 **הסר פריטים בודדים מ{list_info['name']}**\n\n"
        else:
        ...
        for i in range(0, len(items), 2):
            ...
            for j in range(2):
                if i + j < len(items):
                    item = items[i + j]
                    translated_name = self.translate_item_name(item['name'], user_id)
                    item_name = translated_name[:20] + "..." if len(translated_name) > 20 else translated_name
        ...
        # Add back button
        keyboard.append([InlineKeyboardButton(self.get_message(user_id, 'btn_back_to_remove_menu'), callback_data=f"remove_items_{list_id}")])
    ...
    async def show_multiple_items_selection(self, update: Update, context: ContextTypes.DEFAULT_TYPE, list_id: int):
        ...
        for item in items:
            ...
            translated_name = self.translate_item_name(item['name'], user_id)
            item_name = translated_name[:25] + "..." if len(translated_name) > 25 else translated_name
    ...
    async def show_list_menu(self, update: Update, context: ContextTypes.DEFAULT_TYPE, list_name: str):
        ...
        keyboard = [
            [InlineKeyboardButton(self.get_message(user_id, 'btn_templates'), callback_data=f"templates_list_{list_id}")],
    ...
    async def show_template_management_menu(self, update: Update, context: ContextTypes.DEFAULT_TYPE):
        """Show template management menu with list selection"""
        user_id = update.effective_user.id
    ...
    async def show_manage_items_admin(self, update: Update, context: ContextTypes.DEFAULT_TYPE):
        ...
        # Get pending item suggestions count for badge
        item_suggestions_pending = self.db.get_pending_item_suggestions_count()
    ...
    async def show_manage_categories(self, update: Update, context: ContextTypes.DEFAULT_TYPE, back_to: str = "main_menu"):
        ...
        if not custom_categories:
            ...
            # Get pending category suggestions count for badge
            category_suggestions_pending = self.db.get_pending_category_suggestions_count()
    ...
    async def show_templates_menu(self, update: Update, context: ContextTypes.DEFAULT_TYPE, list_id: int):
        ...
        if not templates:
            ...
            for template in templates:  # Show all templates
                ...
                # Truncate button text to fit Telegram's 64 character limit
                button_text = f"{template_name} ({item_count} items){usage_info}"
                if len(button_text) > 60:  # Leave some margin
                    button_text = f"{template_name[:40]}... ({item_count} items){usage_info}"
                    if len(button_text) > 60:
                        button_text = f"{template_name[:30]}... ({item_count}){usage_info}"
        ...
        if len(message) > 4000:  # Leave margin for Telegram's 4096 limit
    ...
    async def show_template_statistics(self, update: Update, context: ContextTypes.DEFAULT_TYPE, list_id: int):
        """Show template statistics for a specific list"""
        user_id = update.effective_user.id
        ...
        user_templates_for_type = [t for t in user_templates if t['list_type'] == list_info['list_type']]
        
        if not user_templates_for_type:
            message = f"📊 **Template Statistics for {list_info['name']}**\n\n"
            ...
            total_items = sum(len(template['items']) for template in user_templates_for_type)
            avg_items_per_template = total_items / total_templates if total_templates > 0 else 0
            
            # Find most used template
            most_used_template = max(user_templates_for_type, key=lambda t: t.get('usage_count', 0))
            most_used_count = most_used_template.get('usage_count', 0)
            
            # Count items by category across all templates
            category_counts = {}
            ...
            message = f"📊 **Template Statistics for {list_info['name']}**\n\n"
            message += f"📈 **Overview:**\n"
            message += f"• Total Templates: {total_templates}\n"
            message += f"• Total Items: {total_items}\n"
            message += f"• Average Items per Template: {avg_items_per_template:.1f}\n\n"
            
            if most_used_count > 0:
                message += f"🏆 **Most Used Template:**\n"
                message += f"• {most_used_template['name']} ({most_used_count} uses)\n\n"
            
            if category_counts:
                message += f"📂 **Items by Category:**\n"
                ...
                if len(category_counts) > 10:
                    message += f"• ... and {len(category_counts) - 10} more categories\n"
                message += "\n"
            
            message += f"📋 **Your Templates:**\n"
            for template in user_templates_for_type:
    ...
    async def edit_system_template(self, update: Update, context: ContextTypes.DEFAULT_TYPE, template_id: int):
        ...
        # Check if we're already editing this template (to preserve current_items)
        if 'editing_template' in context.user_data and context.user_data['editing_template']['template_id'] == template_id:
            # Use existing editing state
            editing_state = context.user_data['editing_template']
            template_name = editing_state['template_name']
    ...
    async def add_items_to_template(self, update: Update, context: ContextTypes.DEFAULT_TYPE, template_id: int):
        ...
        # Get template info to determine the correct back button
        template = self.db.get_template_by_id(template_id)
    ...
    async def save_template_changes(self, update: Update, context: ContextTypes.DEFAULT_TYPE, template_id: int):
        ...
        if success:
            # Get template info to determine type
            template = self.db.get_template_by_id(template_id)
            is_system = template['is_system_template'] if template else True
    ...
    async def cancel_template_edit(self, update: Update, context: ContextTypes.DEFAULT_TYPE, template_id: int):
        ...
        template = self.db.get_template_by_id(template_id)
        if template:
            list_id = self.db.get_list_id_by_type(template.get('list_type', 'supermarket'))
    ...
    async def show_template_category_items(self, update: Update, context: ContextTypes.DEFAULT_TYPE, category_key: str, template_id: int):
        ...
        if is_system:
            keyboard.append([InlineKeyboardButton("🔙 Back to Template Edit", callback_data=f"edit_system_template_{template_id}")])
        else:
            keyboard.append([InlineKeyboardButton("🔙 Back to Template Edit", callback_data=f"edit_user_template_{template_id}")])
    ...
    async def show_manage_my_templates(self, update: Update, context: ContextTypes.DEFAULT_TYPE, list_id: int):
        """Show user template management interface"""
        user_id = update.effective_user.id
        ...
        if not user_templates:
            await update.callback_query.edit_message_text("❌ No templates found to manage.")
            return
        
        message = f"⚙️ **Manage My Templates**\n\n"
        message += f"**Your Templates** ({len(user_templates)}):\n\n"
    ...
    async def edit_user_template(self, update: Update, context: ContextTypes.DEFAULT_TYPE, template_id: int):
        ...
        if 'editing_template' in context.user_data and context.user_data['editing_template']['template_id'] == template_id:
            ...
            if not template or template['created_by'] != user_id:
                await update.callback_query.edit_message_text("❌ Template not found or you don't have permission to edit it.")
                return
        ...
        # Show items with delete buttons
        for i, item in enumerate(current_items):
            item_name = item['name'][:25]  # Truncate to 25 chars
            button_text = f"🗑️ {item_name}"
            keyboard.append([
    ...
    async def delete_user_template(self, update: Update, context: ContextTypes.DEFAULT_TYPE, template_id: int):
        """Delete a user template"""
        user_id = update.effective_user.id
        
        template = self.db.get_template_by_id(template_id)
        if not template or template['created_by'] != user_id:
            await update.callback_query.edit_message_text("❌ Template not found or you don't have permission to delete it.")
            return
        
        message = f"🗑️ **Delete Template: {template['name']}**\n\n"
        message += f"Items: {len(template['items'])}\n"
        message += f"Usage: {template['usage_count']} times\n"
        message += f"Created: {template['created_at'][:10] if template['created_at'] else 'Unknown'}\n\n"
        message += "Are you sure you want to delete this template?"
        
        # Get list_id from the template's list_type
        list_id = self.db.get_list_id_by_type(template['list_type'])
        
        keyboard = [
            [InlineKeyboardButton("✅ Yes, Delete", callback_data=f"confirm_delete_user_template_{template_id}")],
            [InlineKeyboardButton("❌ Cancel", callback_data=f"manage_my_templates_{list_id}")]
        ]
        
        reply_markup = InlineKeyboardMarkup(keyboard)
        await update.callback_query.edit_message_text(message, reply_markup=reply_markup)

    async def confirm_delete_user_template(self, update: Update, context: ContextTypes.DEFAULT_TYPE, template_id: int):
        """Confirm deletion of user template"""
        user_id = update.effective_user.id
        ...
        if success:
            ...
            message += f"Items: {len(template['items'])}\n"
            message += f"Usage: {template['usage_count']} times\n\n"
            message += "The template has been permanently removed."
            ...
            await update.callback_query.edit_message_text("❌ Failed to delete template. Please try again.")
